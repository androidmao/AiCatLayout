...
public class CameraMask extends FrameLayout {
    ...
    public void init(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.aicat.layout.library.R.styleable.CameraMask, defStyleAttr, 0);
        topMargin = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_topMargin, 0);
        scannerBoxBorderColor = a.getColor(com.aicat.layout.library.R.styleable.CameraMask_cm_scannerBoxBorderColor, Color.WHITE);
        scannerBoxBorderWidth = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_scannerBoxBorderWidth, 1);
        scannerBoxAngleColor = a.getColor(com.aicat.layout.library.R.styleable.CameraMask_cm_scannerBoxAngleColor, Color.YELLOW);
        ...
        scannerBoxAngleBorderWidth = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_scannerBoxAngleBorderWidth, defaultScannerBoxAngleBorderWidth);
        ...
        scannerBoxAngleLength = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_scannerBoxAngleLength, defaultScannerBoxAngleLength);
        maskColor = a.getColor(com.aicat.layout.library.R.styleable.CameraMask_cm_maskColor, 0x99000000);
        maskShape = a.getInt(com.aicat.layout.library.R.styleable.CameraMask_cm_maskShape, MASK_SHAPE_SQUARE);
        sizeRatio = a.getFloat(com.aicat.layout.library.R.styleable.CameraMask_cm_sizeRatio, .6f);
        if (sizeRatio < .3f){
            sizeRatio = .3f;
        }
        if (sizeRatio > 1.0f){
        ...
        text = a.getString(com.aicat.layout.library.R.styleable.CameraMask_cm_text);
        int textColor = a.getColor(com.aicat.layout.library.R.styleable.CameraMask_cm_textColor, Color.WHITE);
        int defaultTextSize = (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, getResources().getDisplayMetrics()) + .5f);
        float textSize = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_textSize, defaultTextSize);
        textSingleLine = a.getBoolean(com.aicat.layout.library.R.styleable.CameraMask_cm_textSingleLine, false);
        textLocation = a.getInt(com.aicat.layout.library.R.styleable.CameraMask_cm_textLocation, LOCATION_BELOW_CAMERA_LENS);
        textVerticalMargin = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_textVerticalMargin, 0);
        textLeftMargin = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_textLeftMargin, 0);
        textRightMargin = a.getDimensionPixelSize(com.aicat.layout.library.R.styleable.CameraMask_cm_textRightMargin, 0);
        a.recycle();
